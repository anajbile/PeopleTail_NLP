# Vader Sentiment Analysis on Peopletail Review Data
...
df = pd.read_csv('/Users/Linda/Downloads/reviews.csv')
df.count(), df.columns
...
export_csv = df.to_csv(r'/Users/Linda/Downloads/reviews_sentiment_11182019.csv', index = None, header=True) #Don't forget to add '.csv' at the end of the path
